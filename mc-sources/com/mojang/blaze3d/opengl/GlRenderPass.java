...
class GlRenderPass implements RenderPassBackend {
	...
	public GlRenderPass(
		final GlCommandEncoder encoder, final GlDevice device, final boolean hasDepthTexture, final int colorAttachmentCount, final ScissorState defaultScissorState
	) {
